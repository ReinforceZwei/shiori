...
import NewCollectionModal from '@/features/collection/component/NewCollectionModal';
import EditCollectionModal from '@/features/collection/component/EditCollectionModal';
